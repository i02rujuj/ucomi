        ...
        <div class="text-sm bg-white shadow-md rounded p-8 mb-4 mx-6 md:mx-0">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full p-2 outline-none bg-slate-100 rounded form-input @error('email') border-red-500 @enderror" id="email" type="email" placeholder="Email Address" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
