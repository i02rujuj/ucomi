...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if(env('DB_CONNECTION')=="mysql"){
            ...
            DB::unprepared("CREATE TRIGGER add_vigente_update_miembros_gobierno BEFORE UPDATE ON miembros_gobierno
                        FOR EACH ROW
                        BEGIN
                            IF NEW.fechaCese IS NULL
                                THEN
            ...
            DB::unprepared("CREATE TRIGGER add_activo_insert_miembros_gobierno BEFORE INSERT ON miembros_gobierno
                        FOR EACH ROW
                        BEGIN
            ...
            DB::unprepared("CREATE TRIGGER add_activo_str_update_miembros_gobierno BEFORE UPDATE ON miembros_gobierno
                        FOR EACH ROW
                        BEGIN
                            IF NEW.deleted_at IS NULL
                            THEN
