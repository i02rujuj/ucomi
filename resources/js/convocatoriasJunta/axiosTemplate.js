import { CONVOCATORIA_UPDATE_URL, CONVOCATORIA_GET_URL, CONVOCATORIA_DELETE_URL, CONVOCATORIA_GETALL_URL, CONVOCATORIA_ADD_URL, CONVOCATORIA_VALIDATE_URL, CONVOCATORIA_CONVOCAR_URL, CONVOCATORIA_ASISTIR_URL } from "./api/endPoints";
import { UPDATE_CONVOCATORIA_AXIOS, GET_CONVOCATORIA_AXIOS, DELETE_CONVOCATORIA_AXIOS, GETALL_CONVOCATORIA_AXIOS, ADD_CONVOCATORIA_AXIOS, VALIDATE_CONVOCATORIA_AXIOS, CONVOCAR_CONVOCATORIA_AXIOS, ASISTIR_CONVOCATORIA_AXIOS } from "./api/apiSender";
import { ENDPOINT_CONVOCATORIA_UPDATE_BBDD, ENDPOINT_CONVOCATORIA_GET_BBDD, ENDPOINT_CONVOCATORIA_DELETE_BBDD, ENDPOINT_CONVOCATORIA_GETALL_BBDD, ENDPOINT_CONVOCATORIA_ADD_BBDD, ENDPOINT_CONVOCATORIA_VALIDATE_BBDD, ENDPOINT_CONVOCATORIA_CONVOCAR_BBDD, ENDPOINT_CONVOCATORIA_ASISTIR_BBDD } from "./api/apiConst";
...
function CONVOCAR_CONVOCATORIA_BBDD(data) {
    ENDPOINT_CONVOCATORIA_CONVOCAR_BBDD.url = CONVOCATORIA_CONVOCAR_URL;
    ENDPOINT_CONVOCATORIA_CONVOCAR_BBDD.data = data;
    return CONVOCAR_CONVOCATORIA_AXIOS().then((response) => {
        return response.data;
    }).catch((error) => {
        return error;
    });
...
function ASISTIR_CONVOCATORIA_BBDD(data) {
    ENDPOINT_CONVOCATORIA_ASISTIR_BBDD.url = CONVOCATORIA_ASISTIR_URL;
    ENDPOINT_CONVOCATORIA_ASISTIR_BBDD.data = data;
    return ASISTIR_CONVOCATORIA_AXIOS().then((response) => {
        return response.data;
    }).catch((error) => {
        return error;
    });
...
export {
    ...
    CONVOCAR_CONVOCATORIA_BBDD,
    ASISTIR_CONVOCATORIA_BBDD,
}