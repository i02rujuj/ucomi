        ...
        <div class="mx-auto p-6">
            ...
            <form method="post" action="/save_image_perfil" enctype="multipart/form-data" class="bg-white p-8 mb-6 rounded-lg shadow-md">
                ...
                <div class="form-group flex flex-col gap-2">
                    ...
                    <hr class="border-t border-slate-200 my-2">
                    <img src="{{ asset('storage/' . (Auth::user()->image ? Auth::user()->image : 'default_image.png')) }}" alt="Imagen de perfil" class="w-28 h-28 self-start ml- mb-1 justify-self-center rounded-full object-cover">
